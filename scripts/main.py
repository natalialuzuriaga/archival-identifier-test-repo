...
def generate_markdown_table(stats_list):
    ...
    markdown += "This report was automatically generated by the [archival-identifier](https://github.com/DSACMS/archival-identifier) tool to identify potential archival candidates based on development activity and other repository statistics.\n\n"
...
def main():
    ...
    for repo in data["repos"]:
        ...
        dependents_count, criticality_score = get_criticality_score(os.getenv("ORG_NAME"), repo["name"], os.getenv("GITHUB_ORG_TOKEN"))
